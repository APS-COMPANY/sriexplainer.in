...
export const metadata: Metadata = {
  title: "Download Sri Explainer App • Windows PC & Android APK (v1.2.1)",
  ...
  keywords: ["Sri Explainer app download", "Sri Explainer apk", "Sri Explainer Windows exe", "Tamil web series app", "Sri Explainer 1.2.1 apk"],
  openGraph: {
