...
export default function DownloadAppsPage() {
  ...
  const androidDownloadUrl = "https://github.com/APS-COMPANY/sriexplainer.in/releases/download/v1.2.5/SriExplainer.apk";
  const androidDirectMirror = "/sriexplainer.apk";
  const windowsDownloadUrl = "https://github.com/APS-COMPANY/sriexplainer.in/releases/download/v1.2.5/SriExplainer-Setup.exe";
