...
export default function DownloadAppsPage() {
  ...
  const androidDownloadUrl = "https://github.com/APS-COMPANY/sriexplainer.in/releases/download/v1.2.4/SriExplainer.apk";
  const androidDirectMirror = "/sriexplainer.apk";
  const windowsDownloadUrl = "https://github.com/APS-COMPANY/sriexplainer.in/releases/download/v1.2.4/SriExplainer-Setup.exe";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          ...
          >
            ...
            <div className="pt-8 space-y-3">
              ...
              >
                <Download size={18} />
                <span>Download Android APK (v1.2.4)</span>
              </a>
