...
import { AuditItem } from "../../lib/seo-types";
...
export function AuditCard({ item }: { item: AuditItem }) {
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-[#0E0E0E]/80 p-4 space-y-3 backdrop-blur-md shadow-md transition-all hover:border-white/20">
