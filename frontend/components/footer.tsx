...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/15 bg-[#000000] text-zinc-300 py-10 text-xs mt-auto relative z-10 w-full select-none">
      <div className="px-4 sm:px-8 space-y-8 max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-white/15">
          <div className="space-y-1.5 text-center md:text-left">
            <h3 className="text-base sm:text-lg font-black text-white flex items-center justify-center md:justify-start gap-2 font-display tracking-tight">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {whatsappUrl && (
              <a
                ...
                className="flex items-center gap-2 rounded-full bg-white text-black hover:bg-zinc-200 border border-white px-5 py-2.5 text-xs sm:text-sm font-bold shadow-md hover:scale-105 active:scale-95 transition-all font-display"
              >
            ...
            {telegramUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 rounded-full bg-[#141414] text-white hover:bg-white hover:text-black border border-white/20 px-5 py-2.5 text-xs sm:text-sm font-bold shadow-md hover:scale-105 active:scale-95 transition-all font-display"
              >
